...
public class MenuDocenteActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {

    String[] ViewValues = {"Crear", "Modificar", "Ver todos"};
    String[] values = {"Docente.CreateDocenteActivity", "Docente.FindByIdDocenteActivity", ""};

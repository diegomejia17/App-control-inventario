...
public class MenuEstudianteActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {

    String[] ViewValues = {"Crear", "Modificar", "Ver todos"};
    String[] values = {"Estudiante.CreateEstudianteActivity", "Estudiante.FindByIdEstudianteActivity", ""};
